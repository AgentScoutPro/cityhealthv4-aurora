  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.timeline({ delay: 0.25 })
        ...
        .from('.h-orb',      { scale: 0.82, opacity: 0, duration: 1.1, ease: 'back.out(1.5)' }, '-=0.70')
    }, heroRef)
    return () => ctx.revert()
  }, [])
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 pt-24 pb-16 md:pt-28 md:pb-20
        ...
        <div className="flex-1 max-w-2xl lg:pr-8">
          ...
          <p className="h-sub font-body text-ink-2 leading-relaxed mb-8 max-w-lg"
            style={{ fontSize: 'clamp(1rem, 1.8vw, 1.12rem)' }}>
            Discover expert pain relief with City Health Services. Embark on a journey toward
            comprehensive pain relief — where advanced diagnostics, precision adjustments, and
            evidence-based care converge to restore your quality of life.
          </p>
